...
export default async function AdminCustomerDetailPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <Link href="/admin/customers" className="text-sm text-ink/50 hover:text-walnut-600">
          ← Customers
        </Link>
                ...
                {orders.map((o) => (
                  <tr key={o.id}>
                    <td className="px-5 py-3">
                      <Link href={`/admin/orders/${o.id}`} className="font-medium text-walnut-600 hover:underline">
                        #{o.id}
                      </Link>
                    </td>
