            ...
            {customers.map((c) => (
              <tr key={c.id}>
                <td className="px-5 py-3">
                  <Link href={`/admin/customers/${c.id}`} className="font-medium text-ink hover:text-walnut-600">
                    {c.name}
                  </Link>
                </td>
                ...
                <td className="px-5 py-3 text-right">
                  <Link href={`/admin/customers/${c.id}`} className="text-sm font-medium text-walnut-600 hover:underline">
                    View
                  </Link>
                </td>
              </tr>
