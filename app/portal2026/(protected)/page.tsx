...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    { label: "Products", value: stats.productCount, href: "/portal2026/products" },
    { label: "Orders", value: stats.orderCount, href: "/portal2026/orders" },
    { label: "Revenue", value: formatPrice(stats.revenueTotal), href: "/portal2026/orders" },
    { label: "Unread messages", value: unreadMessages, href: "/portal2026/messages" },
    { label: "Low stock", value: stats.lowStockProducts.length, href: "/portal2026/products" },
  ];
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-walnut-100 bg-white/60 p-5">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/portal2026/orders" className="text-sm text-walnut-600 hover:underline">
              View all →
            </Link>
          </div>
            ...
            <ul className="flex flex-col divide-y divide-walnut-100">
              {stats.recentOrders.map((order) => (
                <li key={order.id} className="flex items-center justify-between py-3 text-sm">
                  <div>
                    <Link
                      href={`/portal2026/orders/${order.id}`}
        ...
        <div className="rounded-2xl border border-walnut-100 bg-white/60 p-5">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/portal2026/products" className="text-sm text-walnut-600 hover:underline">
              View all →
            </Link>
          </div>
